...
contract ERC721 is ERC165, IERC721 {
     ...
     */
    function indexOf(address owner, uint256 tokenId)
        public
        view
        returns (uint256)
    {
        ...
        returns (bool success, uint256 newIndex)
    {
        ...
        require(
            ...
            "ERC721: Owner already owned token"
        );
    ...
    */
        ...
        returns (bool success, uint256 index)
    {
        ...
        require(
            _tokenOwners[tokenId] == owner,
            "ERC721: Invalid ownership - Token is not owned by owner"
        );
        ...
        if (_ownerTokens[owner].length > 1) {
            uint256 lastToken = _ownerTokens[owner][_ownerTokens[owner].length -
                1];
